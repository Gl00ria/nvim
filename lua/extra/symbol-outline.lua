...
vim.g.symbols_outline = {
	...
	symbols = {
		...
		Namespace = { icon = icons.kind.Namespace, hl = "CmpItemKindModule" },
		Package = { icon = icons.ui.Package, hl = "CmpItemKindModule" },
		...
		Key = { icon = icons.type.Key, hl = "CmpItemKeyword" },
		Null = { icon = icons.type.Null, hl = "TSKeyword" },
